...
latex_documents = [
    (master_doc, 'pytheas.tex', 'pytheas Documentation',
...
texinfo_documents = [
    (master_doc, 'pytheas', 'pytheas Documentation',
     author, 'pytheas', 'Python Electromagnetic Analysis and Simulation with the Finite Element Method',
     'Science/Engineering'),
]
