...
Function{
	...
	For i In {1:2}
		...
		mu[L~{i}]       = TensorDiag[1,1,1];
		nu[L~{i}]       = TensorDiag[1,1,1];
	EndFor
	For i In {4:6}
		epsilon[L~{i}]  = Complex[eps_re_L~{i} , eps_im_L~{i}] * TensorDiag[1,1,1];
		mu[L~{i}]       = TensorDiag[1,1,1];
...
// Why this does not work?
//	epsilon_annex[PMLbot]       = eps_re_L_4*TensorDiag[sz*sy[]/sx,sx*sz/sy[],sx*sy[]/sz];
//	epsilon_annex[PMLtop]       = eps_re_L_1*TensorDiag[sz*sy[]/sx,sx*sz/sy[],sx*sy[]/sz];
  ...
  For i In {0:nb_slice-1}
		...
		// Printf("Subs cuts");
		// Printf("%lf",		zcut_sub~{i});
		// Printf("Super cuts");
		// Printf("%lf",		zcut_sup~{i});
	EndFor
...
/*                 		In Omega; Jacobian JVol; Integration Int_1;  }*/
/*                   Galerkin { [0. , {u}];*/
/*                 		In SurfNeumann; Jacobian JSur; Integration Int_1;  }*/
/*                }*/
/*            }*/
/*        }*/
