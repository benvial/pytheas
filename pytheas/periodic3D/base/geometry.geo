...
Point(32) = { period_x/2,-period_y/2, PML_top_hh, lc_layer1};
...
Plane Surface(177) = {175}; // base L_4
...
Line Loop(10003) = {305};
Plane Surface(10004) = {10002};
Line Loop(10005) = {28, 29, 26, 27};
Line Loop(10006) = {328};
Plane Surface(10007) = {10005};
...
Surface Loop(10012) = {174, 143, 111, 159, 127, 177};
Volume(10013) = {10012};//L_5 under
Surface Loop(10014) = {177, 113, 161, 129, 145, 10004};
Volume(10015) = {10014};//L_4
Surface Loop(10016) = {10004, 115, 163, 131, 147, 10007};
Volume(10017) = {10016};//L_3
Surface Loop(10018) = {10007, 149, 117, 165, 133, 188};
Volume(10019) = {10018};//L_2 cover
