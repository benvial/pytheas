...
class ElectrostatPerFEM2D:
    """A class for computing electrostatic fields of
    a periodic 2D medium using a finite element model with Gmsh_ and GetDP_.
    ...
    def make_param_dict(self):
        ...
        param_dict["E_static"] = self.E_static
        param_dict["domX_L"] = self.domX_L
        param_dict["domX_R"] = self.domX_R
        param_dict["domY_B"] = self.domY_B
        param_dict["domY_T"] = self.domY_T
